...
<!--        <li>
        ...
        <div class="collapse" id="collapseVolunteer" data-bs-parent="#sidenavAccordion">
          <ul>
            <li><a class="nav-link" href="#">봉사일정</a></li>
            <li><a class="nav-link" href="#">봉사장소</a></li>
          </ul>
        </div>
      </li> -->
...
<!--       <li>
        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
          <i class="fas fa-book-open"></i><span id="menuFirst"></span>
          <span class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></span>
        </a>
        <div class="collapse" id="collapsePages" data-bs-parent="#sidenavAccordion">
          <ul>
            <li><a class="nav-link" href="/admin/menu.do">메뉴관리</a></li>
            <li><a class="nav-link" href="/admin/comm.do">코드관리</a></li>
          </ul>
        </div>
      </li> -->
...
<!--       <li>
        ...
        <div class="collapse" id="collapseSample" data-bs-parent="#sidenavAccordion">
          <ul>
            <li><a class="nav-link" href="/sample/view/sampleForm">폼화면</a></li>
            <li><a class="nav-link" href="/sample/view/sampleList">리스트화면</a></li>
            <li><a class="nav-link" href="/sample/view/sampleTreeForm">트리폼화면</a></li>
          </ul>
        </div>
      </li> -->
