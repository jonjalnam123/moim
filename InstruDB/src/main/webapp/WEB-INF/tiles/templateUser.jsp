...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/static/css/commonUser.css">
...
<body>
<div class="wrapper idb-layout-root">

    <!-- HEADER 영역 -->
    <header class="idb-layout-header">
        <tiles:insertAttribute name="header"/>
    </header>

    <!-- BODY 영역 -->
    <main class="idb-layout-body">
        <tiles:insertAttribute name="body"/>
    </main>

    <!-- FOOTER 영역 -->
    <footer class="idb-layout-footer">
